...
class TestCategory:
    def test_init(self):
        ...
        with assume: assert Category.PROGRAMMING_LANGUAGES._default_usage == "That's what it's written in"
    ...
    def test_default_usage(self):
        with assume: assert type(Category.PROGRAMMING_LANGUAGES.default_usage) is str
        with assume: assert type(Category.PROGRAMMING_LANGUAGES._default_usage) is str
        with assume: assert Category.PROGRAMMING_LANGUAGES.default_usage == "That's what it's written in"
